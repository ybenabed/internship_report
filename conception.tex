...
A random sample of a size \mbox{DEFAULT\_DATA\_SIZE} is picked for each column
...
\paragraph{Approach 4}: This approach has also the same logic of the second one,
