...
% machine learning search field as its exhaustive solutions require a lot of
% time and resources to find the solution. Due to the complexity in time of the
...
% \acrfull{lsh} is one of the methods that tackles the problem of the
% approximate nearest neighbor search, it consists of using the hashing
% technique to map the near data points to the same buckets with high
% probability, and map the distant one to the same buckets with low probability.
